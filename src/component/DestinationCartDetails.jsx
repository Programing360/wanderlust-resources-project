        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="flex-1 py-2">
                  <div className="animate-text flex items-center gap-2 text-purple-600 mb-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em]">
                      {cartDetailsData.country}
                    </span>
                  </div>

                  <h2 className="animate-text text-3xl font-bold text-gray-900 mb-3">
                    {cartDetailsData.title}
                  </h2>
                  ...
                  <div className="animate-text flex flex-wrap items-center justify-between gap-6 pt-6 border-t border-gray-50">
                    <div className="flex items-center gap-5 bg-gray-50 p-2 rounded-2xl border border-gray-100">
                      <button
                        ...
                        className="w-10 h-10 flex items-center justify-center bg-white rounded-xl shadow-sm hover:text-purple-600 active:scale-90 transition-all"
                      >
                        <Minus size={18} />
                      </button>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-2xl font-black text-gray-900">
                        ${cartDetailsData.price.toLocaleString()}
                      </p>
                    </div>
                  </div>
                  <Button
                    onClick={() => destinationDataById(destinationData, userId)}
                    className={"w-full bg-purple-500 mt-4 hover:bg-purple-600 transition-all"}
                  >
                    Booking now
                  </Button>
                </div>
            ...
            <div className="animate-text p-6 bg-purple-50 rounded-[2rem] border border-purple-100 flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-purple-900">
                  GSAP Protection Secured
                </h4>
                <p className="text-sm text-purple-700/70">
                  Enjoy smooth transitions and robust performance in your
                  booking.
                </p>
              </div>
            </div>
          ...
          <div ref={rightSideRef} className="lg:col-span-4">
            <div className="bg-[#111] rounded-[2.5rem] p-8 text-white shadow-2xl sticky top-10">
              <h3 className="animate-text text-xl font-bold mb-8">
                Checkout Summary
              </h3>
              ...
              <div className="animate-text flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="py-3 bg-white/5 hover:bg-white/10 rounded-2xl text-sm font-bold border border-white/10 transition-all">
                    Modify
                  </button>
                  <button
                    onClick={handleCancel}
                    className="py-3 bg-red-500/10 hover:bg-red-500/20 rounded-2xl text-red-400 text-sm font-bold border border-red-500/20 transition-all"
                  >
                    Cancel
                  </button>
                </div>
